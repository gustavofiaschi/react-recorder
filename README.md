## Main Content
- [Template do Projeto](https://github.com/coreui/coreui-free-react-admin-template)

- [WebAPI]
- [http://gestaoacervoapi.azurewebsites.net/api/compositor]
- [http://gestaoacervoapi.azurewebsites.net/api/gravadora]
- [http://gestaoacervoapi.azurewebsites.net/api/tema]
- [http://gestaoacervoapi.azurewebsites.net/api/interprete]
